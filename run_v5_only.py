#!/usr/bin/env python3
"""Run V5 only — full 5-fold CV, all models, no shortcuts."""
...
def main():
    ...
    save_submission(results["test_ids"], results["predictions"], filename="submission_v5.csv")
