#!/usr/bin/env python3
"""Run V6 only — full 5-fold CV, all models, no shortcuts."""
...
def main():
    ...
    # Build V6 models (full mode)
    logger.info(f"\n[BUILD] Building V{version} models (full 5-fold CV, all models)...")
    logger.info("  Key V6 changes: lr=0.01, feature selection, rank features, stronger reg")
    ...
    save_submission(results["test_ids"], results["predictions"], filename="submission_v6.csv")
