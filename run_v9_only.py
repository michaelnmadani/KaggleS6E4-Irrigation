#!/usr/bin/env python3
"""Run V9 only — full 5-fold CV, all models, no shortcuts."""
...
def main():
    ...
    # Build V9 models (full mode)
    logger.info(f"\n[BUILD] Building V{version} models (full 5-fold CV, all models)...")
    logger.info("  Key V9 changes: revert to V7 hyperparams, CatBoost depth=7, probability calibration")
    ...
    save_submission(results["test_ids"], results["predictions"], filename="submission_v9.csv")
