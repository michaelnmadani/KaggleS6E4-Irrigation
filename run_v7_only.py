#!/usr/bin/env python3
"""Run V7 only — full 5-fold CV, all models, no shortcuts."""
...
def main():
    ...
    # Build V7 models (full mode)
    logger.info(f"\n[BUILD] Building V{version} models (full 5-fold CV, all models)...")
    logger.info("  Key V7 changes: lr=0.02, per-fold target encoding, V2 hyperparams + domain features")
    ...
    save_submission(results["test_ids"], results["predictions"], filename="submission_v7.csv")
