...
run_step() {
    ...
    echo ""
    echo "============================================"
    echo "  Running step $step at $(date)"
    echo "============================================"
    python -u run_v11_steps.py --step "$step"
...
# Step 6: Blend + finalize
run_step 6 ""

echo ""
echo "============================================"
echo "  ALL V11 STEPS COMPLETE at $(date)"
echo "============================================"
echo ""
ls -la outputs/submissions/submission_v11*.csv 2>/dev/null
